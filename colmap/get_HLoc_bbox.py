...
def extract_bboxes(seq_name):
    # Load the projected 2D points
    keypoints_path = f"./data/{seq_name}/processed/colmap_2d/keypoints.npy"
    projected_2d = np.load(keypoints_path)

    bboxes = []
    for idx, points in enumerate(projected_2d):
    ...
    bboxes_path = f"./data/{seq_name}/processed/colmap_2d/bboxes.json"
